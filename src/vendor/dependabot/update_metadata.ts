// Vendored from https://github.com/dependabot/fetch-metadata (MIT License)
// Source: src/dependabot/update_metadata.ts
// Do not modify - update by replacing with the latest version from upstream.
